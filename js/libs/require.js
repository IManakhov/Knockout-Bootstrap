...
(function(ga) {
    ...
    function Y(b, c, d, g) {
        c && D(c, function(c, e) {
            if (d || !x(b, e))!g || "object" !== typeof c || !c || L(c) || K(c) || c instanceof RegExp ? b[e] = c : (b[e] || (b[e] = {}), Y(b[e], c, d, g))
        });
        return b
    }
    function z(b, c) {
    ...
    function ma(b) {
        function c(a, n, b) {
            ...
            if (b && q && (n || m)) {
                ...
                a: for (; 0 < f; --f) {
                    d = k.slice(0, f).join("/");
                    if (n) for (c = n.length; 0 < c; --c) if (b = e(q, n.slice(0, c).join("/"))) if (b = e(b, d)) {
                        h = b;
                        l = f;
                        break a
        ...
        function w(a, b, c) {
            var h = a.id,
                k = e(t, h);
            if (!x(v, h) || k && !k.defineEmitComplete) if (k = u(a), k.error && "error" === b) c(k.error);
            else k.on(b, c);
        ...
        function H() {
            ...
            if (!aa) {
                ...
                D(Z, function(a) {
                    var l = a.map,
                        e = l.id;
                    if (a.enabled && (l.isDefine || k.push(a), !a.error)) if (!a.inited && c) m(e) ? f = b = !0 : (h.push(e), d(e));
                    else if (!a.inited && a.fetched && l.isDefine && (f = !0, !l.prefix)) return g = !1
                });
        ...
        da.prototype = {
            init: function(a, b, c, h) {
                ...
                if (!this.inited) {
                    ...
                    else this.events.error && (c = z(this, function(a) {
                        this.emit("error", a)
                    }));
        ...
        l = {
            ...
            completeLoad: function(a) {
                ...
                l.defQueueMap = {};
                c = e(t, a);
                if (!b && !x(v, a) && c && !c.inited) if (!p.enforceDefine || g && ia(g)) I([a, d.deps || [], d.exportsFn]);
            ...
            nameToUrl: function(a, b, c) {
                ...
                if (g.jsExtRegExp.test(a)) d = a + (b || "");
                    ...
                    d = p.paths;
                    k = a.split("/");
                    for (f = k.length; 0 < f; --f) if (m = k.slice(0, f).join("/"),
                            m = e(d, m)) {
                        L(m) && (m = m[0]);
                        k.splice(0, f, m);
                        break
